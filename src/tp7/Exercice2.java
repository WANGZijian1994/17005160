...
public class Exercice2 {
	...
	public static void temps() {
		 ...
		 System.out.println("WEEK_OF_YEAR: " + calendar.get(GregorianCalendar.WEEK_OF_YEAR));
		 System.out.println("WEEK_OF_MONTH: " + calendar.get(GregorianCalendar.WEEK_OF_MONTH));
		 ...
		 System.out.println("DAY_OF_YEAR: " + calendar.get(GregorianCalendar.DAY_OF_YEAR));
		 System.out.println("DAY_OF_WEEK: " + calendar.get(GregorianCalendar.DAY_OF_WEEK));
		 ...
		 System.out.println("MILLISECOND: " + calendar.get(GregorianCalendar.MILLISECOND));
