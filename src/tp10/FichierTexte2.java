...
public class FichierTexte2 {
	static String noms[] = {"Nikola Lackovic", "Natalia", "Jughurta Ouali","WANG Zijian", "GAO Shuai","Zeynab", "BENALI_Malika", "Amina AMARA", "sonia", "Matthieu", "Harmonie Begue", "Benziane", "Abdelhak", "DJILLANI Aouataf","SUN_Chen", "Fintan Herlihy", "Arienna Groves", "Rafael Araujo"};
